...
namespace ACFramework
{
    ...
    class cCritter3DArmedEnemy : cCritterArmedRobot
    {
        ...
        public override bool IsKindOf(string str)
        {
            return str == "cCritter3DArmedEnemy" || base.IsKindOf(str);
        }
    ...
    class cGame3D : cGame
    {
        ...
        public void setRoom1()
        {
            ...
            Biota.purgeCritters("cCritter3DArmedEnemy");
        ...
        public override void adjustGameParameters()
        {
            ...
            int modelcount = Biota.count("cCritter3DArmedEnemy");
